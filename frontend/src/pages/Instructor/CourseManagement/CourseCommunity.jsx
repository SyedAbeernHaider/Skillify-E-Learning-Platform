...
function InstructorCourseCommunity() {
                ...
                <div className="participants-sidebar">
                    ...
                    <div className="participants-list">
                        ...
                        {onlineUsers.length === 0 && (
                            <p className="text-gray-500 text-sm mt-2">Waiting for students...</p>
                        )}
                    </div>
                </div>
                ...
                <div className="chat-area">
                    ...
                    <div className="message-input-container">
                        <textarea
                            ...
                            placeholder="Type a message to your students..."
                            rows="3"
                        />
...
export default InstructorCourseCommunity;
